 ...
 */
function fillAnimatedBg(id: string, maxDensity: number) {
 ...
 */
function createShape(type: string, maxSizePx: number): HTMLElement {
    switch (type) {
        case "circle":
 ...
 * */
function createCircleSpan(maxSizePx: number): HTMLElement {
    //Create the element
 ...
 * */
function createTriangleSpan(maxSizePx: number): HTMLElement {
    //Create the element
    var span = document.createElement("span");
    //set the size from a random value  1 to mazSize
    var size = getRandomBetween(1, maxSizePx);
 ...
 * */
function createSquareSpan(maxSizePx: number): HTMLElement {
    //Create the element
    var span = document.createElement("span");
    //set the size from a random value  1 to mazSize
    var size = getRandomBetween(1, maxSizePx);
